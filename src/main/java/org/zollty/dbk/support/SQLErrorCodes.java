...
public class SQLErrorCodes {
	...
	public void setBadSqlGrammarCodes(String badSqlGrammarCodes) {// String[] 
		this.badSqlGrammarCodes = SpringUtils.sortStringArray(SpringUtils.delimitedListToStringArray(badSqlGrammarCodes, ",", null));
	}
	...
	public void setInvalidResultSetAccessCodes(String invalidResultSetAccessCodes) {
		this.invalidResultSetAccessCodes = SpringUtils.sortStringArray(SpringUtils.delimitedListToStringArray(invalidResultSetAccessCodes, ",", null));
	}
	...
	public void setDuplicateKeyCodes(String duplicateKeyCodes) {
		this.duplicateKeyCodes = SpringUtils.delimitedListToStringArray(duplicateKeyCodes, ",", null);
	}

	public void setDataIntegrityViolationCodes(String dataIntegrityViolationCodes) {
		this.dataIntegrityViolationCodes = SpringUtils.sortStringArray(SpringUtils.delimitedListToStringArray(dataIntegrityViolationCodes, ",", null));
	}
	...
	public void setPermissionDeniedCodes(String permissionDeniedCodes) {
		this.permissionDeniedCodes = SpringUtils.sortStringArray(SpringUtils.delimitedListToStringArray(permissionDeniedCodes, ",", null));
	}
	...
	public void setDataAccessResourceFailureCodes(String dataAccessResourceFailureCodes) {
		this.dataAccessResourceFailureCodes = SpringUtils.sortStringArray(SpringUtils.delimitedListToStringArray(dataAccessResourceFailureCodes, ",", null));
	}
	...
	public void setTransientDataAccessResourceCodes(String transientDataAccessResourceCodes) {
		this.transientDataAccessResourceCodes = SpringUtils.sortStringArray(SpringUtils.delimitedListToStringArray(transientDataAccessResourceCodes, ",", null));
	}
	...
	public void setCannotAcquireLockCodes(String cannotAcquireLockCodes) {
		this.cannotAcquireLockCodes = SpringUtils.sortStringArray(SpringUtils.delimitedListToStringArray(cannotAcquireLockCodes, ",", null));
	}
	...
	public void setDeadlockLoserCodes(String deadlockLoserCodes) {
		this.deadlockLoserCodes = SpringUtils.sortStringArray(SpringUtils.delimitedListToStringArray(deadlockLoserCodes, ",", null));
	}
	...
	public void setCannotSerializeTransactionCodes(String cannotSerializeTransactionCodes) {
		this.cannotSerializeTransactionCodes = SpringUtils.sortStringArray(SpringUtils.delimitedListToStringArray(cannotSerializeTransactionCodes, ",", null));
	}
